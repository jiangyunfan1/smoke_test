...
from tools.send_request import send_v1_chat_completions, send_v1_completions
...
def test_aisbench_cases():
    aisbench_cases = [{
        ...
        "dataset_path_local": "/path/to/local_dataset_directory"
    }, {
...
def test_vllm_bench():
    ...
    res = run_vllm_bench_case(model_name, port, config, model_path=model_path)
